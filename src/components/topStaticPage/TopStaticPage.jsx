...
const TopStaticPage = () => {
    return (
        <div className='relative text-center pt-8 md:pt-16 pb-50 md:pb-52 bg-[#9538E2] rounded-lg'>
            ...
            <div className='absolute top-70 md:top-78 left-0 right-0 mx-auto w-10/12 md:w-6/12 '>
